...
test("data.js resets each pane to its own board before loading scripts", () => {
  ...
  assert.match(dataJs, /data-shops\.js\?v=0\.1\.611-data-range-blank/);
  assert.match(dataJs, /data-goods\.js\?v=0\.1\.611-data-range-blank/);
  assert.match(dataJs, /data-overview\.js\?v=0\.1\.611-data-range-blank/);
