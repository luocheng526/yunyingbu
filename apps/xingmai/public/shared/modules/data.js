/* xm-module-data 0.1.607-data-range-blank — isolate panes; range change blanks numbers before new data */
(function () {
  ...
  function mountShopDashboard(root) {
    ...
    return loadScript("/data-shops.js?v=0.1.607-data-range-blank").then(function () {
  ...
  function mountGoodsDashboard(root) {
    ...
    return loadScript("/data-goods.js?v=0.1.607-data-range-blank").then(function () {
  ...
  function mountOverview(root) {
    ...
    return loadScript("/data-ops.js?v=data-ov30").then(function () {
      return loadScript("/data-overview.js?v=0.1.607-data-range-blank");
    }).then(function () {
