/* xm-module-people org-board 0.1.658-search-ime — live search waits for IME; leftover mask cannot steal keys */
(function () {
  ...
  function ensureCss() {
    const href = "/people.css?v=0.1.658-search-ime";
      ...
      function bindLiveSearch(form, input, run) {
        ...
        function schedule() {
          ...
          timer = window.setTimeout(function () {
            ...
            run();
            if (keep && document.activeElement !== input) {
              input.focus();
              try {
