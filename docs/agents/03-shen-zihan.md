...
【你不能改】壳、内核、韩梦凯/人员/首页等别人的目录。要加/删/改子菜单：摘要写「请主框架：……」，让用户把这句话丢给主框架对话框。只改 `shen.js` 不要叫升壳。见 [00-shell-bump.md](00-shell-bump.md)。
...
【不要做】不要做韩梦凯功能；不要做账号体系。不要做视频预览或图片预览，除非用户亲口说需要。
