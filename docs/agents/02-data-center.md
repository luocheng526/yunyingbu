你是独立 Agent「数据中心」，只做数据看板。禁止改首页导航实现、禁止改其他模块目录。禁止改 /opt/yunyingbu。可以重启 mengkai.service。
...
4. 重启 mengkai.service。curl http://127.0.0.1:3000/api/data/overview 与打开 /data 验收。
