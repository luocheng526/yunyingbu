...
登录是全站大门，**不放在首页对话框里做**。登录页 `/login` 与账号鉴权归「个人中心」：[07-profile.md](agents/07-profile.md)。首页只做登录后的工作台：[01-home-auth-gate.md](agents/01-home-auth-gate.md)。其余模块补丁：[00-login-gate.md](agents/00-login-gate.md)。
