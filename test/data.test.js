...
test("data child pages and demo APIs respond", async () => {
  await withServer(async (base) => {
    ...
    assert.match(overviewJs.text, /ch-shop-opt/);
    ...
    assert.match(overviewJs.text, /ch-spark/);
    assert.match(overviewJs.text, /指标说明/);
    assert.match(overviewJs.text, /按支付时间统计的订单金额/);
    assert.match(overviewJs.text, /ch-help/);
    assert.match(overviewJs.text, /SPU推广费用/);
    assert.match(overviewJs.text, /数据总览/);
    assert.match(overviewJs.text, /ch-pill/);
    assert.match(overviewJs.text, /function fmtInt/);
    assert.match(overviewJs.text, /mergeErpShops/);
    assert.match(overviewJs.text, /\/api\/data\/shop-options/);
    assert.match(overviewJs.text, /0\.0000%/);
    ...
    assert.match(overviewJs.text, /data-ov34/);
    ...
    assert.match(overviewJs.text, /经理团队/);
    assert.match(overviewJs.text, /主管团队/);
    assert.match(overviewJs.text, /储备团队/);
    ...
    assert.match(opsJs.text, /数据列表/);
    assert.match(opsJs.text, /显示数字/);
    assert.match(opsJs.text, /op-bars/);
    ...
    assert.match(overviewJs.text, /打包费/);
    assert.match(overviewJs.text, /总营销额/);
    ...
    assert.match(dataModShops.text, /data-shops\.js\?v=shop-wide6/);
...
test("release allowlist never includes the live site entrypoint", () => {
  ...
  assert.equal(isAllowedDataPath("public/data-ops.js"), true);
  ...
  assert.match(dataMod, /data-overview\.js\?v=data-ov34/);
  assert.match(dataMod, /data-ops\.js\?v=data-ov34/);
