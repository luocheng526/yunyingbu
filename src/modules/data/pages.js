...
export function getLiveBoard() {
  return {
    ...
    shopLiveTable: {
      ...
      rows: [
        { name: "当页汇总", kind: "sum", cells: ["165,362.13", "837,247.17", "3,174", "348,174.63", "415,136.64", "49.58%", "2.40", "12,480.50", "5,210.30", "6,180.20", "41.75%"] },
        { name: "RASW家居旗舰店", kind: "shop", color: "#4da6ff", cells: ["22,997.91", "70,190.95", "205", "29,180.40", "34,820.11", "49.60%", "2.41", "1,842.30", "764.20", "912.40", "41.48%"] },
        { name: "RASW旗舰店", kind: "shop", color: "#4da6ff", cells: ["17,568.69", "66,474.58", "177", "27,640.22", "32,910.80", "49.51%", "2.40", "1,620.10", "678.50", "801.30", "41.88%"] },
        { name: "HYGEAR医疗保健旗舰店", kind: "shop", color: "#4da6ff", cells: ["19,986.66", "56,928.22", "177", "23,710.18", "28,210.40", "49.55%", "2.40", "1,410.80", "592.10", "698.20", "41.97%"] },
        { name: "SAWAAG平价专卖店", kind: "shop", color: "#4da6ff", cells: ["14,216.75", "52,932.76", "177", "22,040.66", "26,240.90", "49.57%", "2.40", "1,288.40", "541.80", "636.10", "42.05%"] },
        { name: "RASW生活电器旗舰店", kind: "shop", color: "#e53935", cells: ["8,929.03", "52,426.01", "168", "21,830.10", "25,980.20", "49.56%", "2.40", "1,205.60", "504.20", "592.80", "41.82%"] },
        { name: "RASW个护旗舰店", kind: "shop", color: "#4da6ff", cells: ["10,792.90", "35,991.48", "106", "14,980.40", "17,840.30", "49.57%", "2.40", "880.20", "366.40", "431.50", "41.63%"] },
        { name: "DIKTTT欧格专卖店", kind: "shop", color: "#e53935", cells: ["13,747.75", "34,409.11", "130", "14,320.80", "17,050.60", "49.55%", "2.40", "842.10", "352.80", "414.20", "41.89%"] },
        { name: "RASW健康电器旗舰店", kind: "shop", color: "#4da6ff", cells: ["10,018.13", "30,516.64", "115", "12,700.20", "15,120.80", "49.55%", "2.40", "746.50", "311.20", "366.80", "41.69%"] },
        { name: "HYGEAR健康器械旗舰店", kind: "shop", color: "#4da6ff", cells: ["6,287.11", "29,508.85", "89", "12,280.40", "14,620.10", "49.54%", "2.40", "721.80", "301.50", "354.90", "41.77%"] },
        { name: "ZYUTO旗舰店", kind: "shop", color: "#e53935", cells: ["7,087.40", "29,329.38", "164", "12,210.30", "14,530.40", "49.54%", "2.40", "718.20", "299.80", "352.40", "41.74%"] },
        { name: "SAWAAG居家旗舰店", kind: "shop", color: "#4da6ff", cells: ["5,226.70", "25,147.45", "95", "10,470.20", "12,460.80", "49.55%", "2.40", "615.40", "256.90", "302.10", "41.75%"] },
        { name: "张望居家旗舰店", kind: "shop", color: "#e53935", cells: ["8,850.20", "24,587.95", "107", "10,240.80", "12,180.50", "49.54%", "2.40", "601.80", "251.40", "295.60", "41.77%"] }
      ]
    }
  };
}
